...
function build_epsilon_disorder_wo_subpixel_smoothing(W, L, r_min, r_max, min_sep, number_density, rng_seed, dx, epsilon_scat, epsilon_bg, build_TM, build_TE = false, yBC = "periodic", y1 = 0, y2 = W, z1 = 0, z2 = L; no_scatterer_center = false)
    ...
    if build_TE
        ...
        inv_epsilon_yy = 1/epsilon_bg*ones(ny_Hx, nz_Ex)
    ...
    for ii in 1:N_scatterers
        ...
        if build_TM && ~(no_scatterer_center && ii == 1)
        ...
        if build_TE && ~(no_scatterer_center && ii == 1)
