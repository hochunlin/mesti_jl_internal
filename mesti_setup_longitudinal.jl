...
"""
function mesti_setup_longitudinal(k0dx::Union{Real,Complex}, epsilon_bg::Union{Real,Complex}, kxdx_all::Union{StepRangeLen{<:Real}, Vector{<:Real}, Nothing}, kydx_all::Union{StepRangeLen{<:Real}, Vector{<:Real}}, kLambda_x::Union{Real,Complex,Nothing}=nothing, kLambda_y::Union{Real,Complex,Nothing}=nothing, ind_zero_kx::Union{Integer,Nothing}=nothing, ind_zero_ky::Union{Integer,Nothing}=nothing, use_continuous_dispersion::Bool=false)
