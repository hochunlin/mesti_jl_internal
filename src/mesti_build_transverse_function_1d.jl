...
"""
function mesti_build_transverse_function_1d(nx::Int, xBC::Union{String,Int,Real}, n0::Union{Int,Real}=0, offset::Bool=false)    
...
"""
function mesti_build_transverse_function_1d_derivative(nx::Int, xBC::Union{String,Int,Real}, n0::Union{Int,Real}=0, changegrid::Union{Int,Real}=0)    
    # Check input parameters        
    if ~(nx>=0)
...
"""
function convert_BC_1d(BC::Union{String,Int,Real,Complex},direction::String)
    if isa(BC, Number)
        return BC
